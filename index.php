                ...
                foreach($listActionGames as $value){
                    ...
                    echo "<div class='game'>";
                        ...
                        if (empty($_SESSION['Sale']) || $_SESSION['Sale'] == 1) {
                            ...
                            echo ("<span id='game-price' class='sale'>$myrow[Prix]€</span>");
                            echo ("<span id='game-price' >" . number_format($myrow['Prix'] * 0.9, 2) . "€</span>");
                            echo ("</div>");
                        } else {
                            echo ("<span id='game-price' class='sale'>$myrow[Prix]€</span>");
                            echo ("<span id='game-price'>" . number_format($myrow['Prix'] * 0.8, 2) . "€</span>");
                            echo ("</div>");
                        }
