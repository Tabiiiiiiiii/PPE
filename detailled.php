...
<body style="background-color: rgb(51, 51, 51);">
    ...
    <div class="card">
        ...
        if (empty($_SESSION['Sale']) || $_SESSION['Sale'] == 1) {
            echo ("<span  id='card-infos-game-inner-price'>$myrow[Prix]€</span>");
            echo ("</div>");
        } elseif ($_SESSION['Sale'] == 2) {
            echo ("<span  id='card-infos-game-inner-price' class='sale'>$myrow[Prix]€</span>");
            echo ("<span  id='card-infos-game-inner-price' >" . number_format($myrow['Prix'] * 0.9, 2) . "€</span>");
            echo ("</div>");
        } else {
            echo ("<span id='card-infos-game-inner-price' class='sale'>$myrow[Prix]€</span>");
            echo ("<span  id='card-infos-game-inner-price'>" . number_format($myrow['Prix'] * 0.8, 2) . "€</span>");
            echo ("</div>");
        }
